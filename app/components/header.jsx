                ...
                <div className="flex h-full space-x-8">
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      {({ open }) => (
                        <>
                          <div className="relative flex after:absolute after:w-0 hover:after:w-full after:transition-all after:h-[1px] after:bg-gray-800 after:bottom-1 after:left-0">
                            <Popover.Button
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-base relative font-medium text-gray-700 hover:text-gray-800 after:absolute after:w-0 hover:after:w-full after:h-[1px] after:transition-all after:bg-gray-800 after:bottom-1 after:left-0"
                    >
                      {page.name}
                    </a>
                  ))}
